...
public class ModalTemCertezaExcluirView extends JFrame implements ActionListener{
   ...
   public ModalTemCertezaExcluirView(){
      super("Santicioli Restaurante");
      rc();
      getContentPane().setLayout(null);
      		
      lTitle = new JLabel(bn.getString("confirmexpl"));
   ...
   public static void main(String [] args){
      ModalTemCertezaExcluirView c = new ModalTemCertezaExcluirView();
   }
}
