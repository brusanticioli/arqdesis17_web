...
public class PedidoInserirDAO {
	...
	public PedidoInserirDAO(int id, int quantidade, int  produto, int garcom, String dataEntrada, String dataSaida)
	{
		setId(id);
	...
	public void incluir(int id, int quantidade, int  produto, int garcom, String dataEntrada, String dataSaida)
	{
		try
		{
			iniciarConexao();
			String sqlInsert = "INSERT INTO pedidos(produto,quantidade,garcom,dataEntrada,dataSaida) VALUES (?, ?, ?, ?, ?);";
